...
export default function RegisterPage() {
  ...
  return (
    <div
      ...
      style={{ background: '#09160d', minHeight: '100vh' }}
    >
      <div
        className="w-full max-w-[420px] rounded-2xl p-5 sm:p-8 overflow-y-auto"
        style={{
          background: '#0b1d0f',
          border: '1px solid rgba(74,222,128,0.18)',
          maxHeight: '100vh',
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          {/* Name */}
          <div className="mb-4">
            <label className="block text-[11.5px] mb-2" style={{ color: 'rgba(255,255,255,0.4)' }}>
              Full name
            </label>
