...
export default function RegisterPage() {
  ...
  return (
    <div
      className="flex justify-center px-4 py-8 sm:py-12"
      style={{ background: "#09160d", minHeight: "100dvh" }}
    >
      <div
        className="w-full max-w-[420px] rounded-2xl p-5 sm:p-8 h-fit"
        style={{
          background: "#0b1d0f",
          border: "1px solid rgba(74,222,128,0.18)",
        }}
      >
        ...
        >
          Join Amara — your GGCL learning companion
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                style={optionBtnStyle(role === "girl")}
              >
                👧 Girl
              </button>
              <button
                ...
                style={optionBtnStyle(role === "facilitator")}
              >
                👩‍🏫 Facilitator
              </button>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  style={optionBtnStyle(ageGroup === "10-13")}
                >
                  Ages 10–13
                </button>
                <button
                  type="button"
                  onClick={() => setAgeGroup("14-18")}
                  style={optionBtnStyle(ageGroup === "14-18")}
                >
                  Ages 14–18
                </button>
              </div>
          ...
          {needsConsent && (
            <div className="mb-4 flex items-start gap-3">
              ...
              >
                I confirm that a parent or guardian has given consent for this
                account (required for ages 10–13)
              </label>
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              fontFamily: "DM Sans, sans-serif",
              cursor:
                loading || (needsConsent && !consent)
                  ? "not-allowed"
                  : "pointer",
              opacity: loading || (needsConsent && !consent) ? 0.6 : 1,
        ...
        >
          ...
          <Link href="/login" style={{ color: "#4ade80" }}>
            Sign in
          </Link>
        </div>
      </div>
