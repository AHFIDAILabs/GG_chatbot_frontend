...
export default function LoginPage() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    border: '1px solid rgba(74,222,128,0.18)', color: '#d1fae5',
    fontSize: 16, fontFamily: 'DM Sans, sans-serif',
    outline: 'none', boxSizing: 'border-box',
  };

  return (
    <div className="w-full overflow-y-auto" style={{ background: '#09160d', minHeight: '100dvh' }}>
      <div className="flex justify-center px-4 py-8 sm:py-16">
        <div
          className="w-full rounded-2xl p-5 sm:p-8"
          style={{ maxWidth: 400, background: '#0b1d0f', border: '1px solid rgba(74,222,128,0.18)' }}
        >
          {/* Brand */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-5 sm:mb-6">
              <label className="block text-[11.5px] mb-2" style={{ color: 'rgba(255,255,255,0.4)' }}>Password</label>
          ...
          <div className="text-center mt-4 text-[13px]" style={{ color: 'rgba(255,255,255,0.4)' }}>
            Don&apos;t have an account?{' '}
            <Link href="/register" style={{ color: '#4ade80' }}>Create one</Link>
          </div>
